...
//Global Variables
Minim minim;
AudioPlayer song0, song1, song2, song3, song4, song5, song6, song7, song8, song9, song10, song11, song12, song13, song14;
...
void setup() {
  ...
  song12 = minim.loadFile("../Music/kuschelsong.mp3");
  song13 = minim.loadFile("../Music/Moshi Monsters - Big Bad Bill and the Woolly Blue Hoodoos - Go Do The Hoodoo - Music Video.mp3");
  song14 = minim.loadFile("../Music/Lemon Demon - Ivanushka (Touch-Tone Telephone, 2009).mp3");
